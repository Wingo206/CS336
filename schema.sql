...
insert into flight (airline, flownBy, departureAirport, departureTime, arrivalAirport, arrivalTime, price) values ('UA', 'ua1', 'JFK', '2023-11-05 12:00:00', 'LAX', '2023-11-05 13:00:00', 400.00);
insert into flight (airline, flownBy, departureAirport, departureTime, arrivalAirport, arrivalTime, price) values ('UA', 'ua2', 'LAX', '2023-11-26 12:00:00', 'JFK', '2023-11-26 13:00:00', 400.00);
insert into flight (airline, flownBy, departureAirport, departureTime, arrivalAirport, arrivalTime, price) values ('UA', 'ua1', 'JFK', '2023-11-26 16:00:00', 'DEL', '2023-11-26 19:00:00', 300.00);
...
primary key (flightNumber, ticketId), foreign key(flightNumber, airline) references flight(flightNumber, airline) on update cascade, foreign key(ticketID) references flightTicket(ticketId) on update cascade on delete CASCADE);
